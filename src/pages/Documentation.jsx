export default function Documentation() {
  return (
    <div className="max-w-7xl mx-auto p-6 min-h-screen bg-white text-gray-900">
      <h1 className="text-3xl font-bold mb-4">
        📚 College Paper Explorer Documentation
      </h1>

      <p className="mb-4">
        College Paper Explorer (ResearchMate) is a web app for students to
        explore research papers from arXiv.org. This page explains how to use
        the app.
      </p>
      ...
      <ol className="list-decimal pl-6">
        ...
        <li>
          Type a keyword like <strong>Deep Learning</strong> or{" "}
          <strong>Quantum Computing</strong> in the search bar.
        </li>
        <li>
          Optionally select a <strong>category/subject</strong> from the
          dropdown or leave it as "All Fields".
        </li>
        <li>
          Click <strong>Search</strong> to view results or{" "}
          <strong>Clear</strong> to reset.
        </li>
        <li>Use pagination at the bottom to navigate pages.</li>
        <li>
          Click the <strong>star icon</strong> on a paper card to add it to
          Favorites. View saved papers on the Favorites page.
        </li>
      </ol>
      ...
      <ul className="list-disc pl-6">
        ...
        <li>
          First-time users see the latest papers from all major categories.
        </li>
      </ul>
    </div>
  );
